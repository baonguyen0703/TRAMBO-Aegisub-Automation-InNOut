script_name="@TRAMBO: In N Out 2.1"
...
--    { class = "dropdown", x = 1, y = 3, width = 1, height = 1, items = {"None", "Random", "L -> R","L -> R no fade", "L <- R", "L <- R no fade","-> C <-","<- C ->"}, value = dirin, name = "inD", hint = "L = Left, R = Right, C = Center"},
--    { class = "dropdown", x = 2, y = 3, width = 1, height = 1, items = {"None", "Random", "L -> R","L -> R no fade", "L <- R", "L <- R no fade","-> C <-","<- C ->"}, value = dirout, name = "outD", hint = "L = Left, R = Right, C = Center"},
